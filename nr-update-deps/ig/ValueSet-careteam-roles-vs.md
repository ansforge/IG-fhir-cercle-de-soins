...
| Active as of 2025-11-06 | *Computable Name*:CareTeamRolesValueSet |
...
* Inclut ce(s) code(s) tel quil(s) est (sont) défini(s) dans [`https://mos.esante.gouv.fr/NOS/TRE_R259-HL7ParticipationFunction/FHIR/TRE-R259-HL7ParticipationFunction`](https://interop.esante.gouv.fr/terminologies/1.2.0/CodeSystem-TRE-R259-HL7ParticipationFunction.html)version 📦20231215120000
...
```json
{
  ...
  "status" : "active",
  "date" : "2025-11-06T10:00:57+00:00",
  "publisher" : "ANS",
  "contact" : [
    {
      "name" : "ANS",
