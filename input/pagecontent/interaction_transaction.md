...
* La ressource référencée en tant que sujet du Cercle de Soins : la ressource Patient (profil FrCorePatientProfile, contenant de préférence un identifiant, un telecom et une address),
