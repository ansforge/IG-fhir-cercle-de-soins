...
Profile: [CDS Fr RelatedPerson Profile](StructureDefinition-cds-fr-related-person.md)

**identifier**: `https://fake-system`/id-relatedPerson-12 (use: temp, )

**active**: true

**patient**: [Jacques Thobois (official) Male, DoB: 1984-10-02 ( NIR définitif (use: official, ))](Patient-cds-patient-example.md)
