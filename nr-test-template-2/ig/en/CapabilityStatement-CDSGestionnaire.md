...
| | | | | | | | | | | | | |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| [CareTeam](#en-CareTeam1-1) | [https://interop.esante.gouv.fr/ig/fhir/cds/StructureDefinition/cds-ihe-careteam|2.0.1](StructureDefinition-cds-ihe-careteam.md) | y | y | y | y | y | y | y | identifier, start, end, status, _lastUpdated, category, participant-start, participant-end, date, participant, patient, subject, managingOrganization |  |  |  |
| [Patient](#en-Patient1-2) | [https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-patient|2.1.0](https://hl7.fr/ig/fhir/core/2.1.0/StructureDefinition-fr-core-patient.html) | y |  | y | y | y |  |  | identifier, family, given, name, address, birthdate, gender, birthplace |  |  |  |
| [RelatedPerson](#en-RelatedPerson1-3) | [https://interop.esante.gouv.fr/ig/fhir/cds/StructureDefinition/cds-fr-related-person|2.0.1](StructureDefinition-cds-fr-related-person.md) | y |  | y | y | y |  |  | _id, name, relationship |  |  |  |
| [Practitioner](#en-Practitioner1-4) | [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-practitioner|1.1.0](https://interop.esante.gouv.fr/ig/fhir/annuaire/1.1.0/StructureDefinition-as-practitioner.html) | y |  | y | y | y |  |  | identifier, name |  |  |  |
| [PractitionerRole](#en-PractitionerRole1-5) | [https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-practitionerrole|1.1.0](https://interop.esante.gouv.fr/ig/fhir/annuaire/1.1.0/StructureDefinition-as-practitionerrole.html) | y |  | y | y | y |  |  | _id, practitioner, role |  |  |  |
| [Organization](#en-Organization1-6) | [https://interop.esante.gouv.fr/ig/fhir/cds/StructureDefinition/cds-organization|2.0.1](StructureDefinition-cds-organization.md) | y |  | y | y | y |  |  | _id, identifier, name |  |  |  |
...
* Supports `update`, `search-type`, `read`, `create`, `vread`, `history-instance`, `history-type`.
