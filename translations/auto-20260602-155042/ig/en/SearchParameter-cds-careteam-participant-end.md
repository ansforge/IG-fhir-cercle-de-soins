...
Date of departure of a member of the circle of care 
...
```json
{
  ...
  "_name" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "CDSCareTeamParticipantEnd"
      }],
  ...
  "_description" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "Date of departure of a member of the circle of care"
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
