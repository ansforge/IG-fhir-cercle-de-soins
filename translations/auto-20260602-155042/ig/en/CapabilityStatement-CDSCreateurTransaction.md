# CI-SIS Circle of Care Management - CreateurTransaction - Cercle De Soins v2.0.1

## CapabilityStatement: CI-SIS Circle of Care Management - CreateurTransaction 
...
```json
{
  ...
  "_name" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "CreateurTransaction-cds"
      }],
  ...
  "_title" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "CI-SIS Care Circle Management - CreateurTransaction"
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
    ...
    "security" : {
      ...
      "_description" : {
        "extension" : [{
          ...
          {
            "url" : "content",
            "valueString" : "ANS provides repositories dedicated to security policy (PGSSI-S) and security mechanisms are defined in the Transport layer sections of the Interoperability Framework for Health Information Systems (CI-SIS)"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        }]
      }
