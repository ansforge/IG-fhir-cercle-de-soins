...
Profile: [CDS Organization Profile](StructureDefinition-cds-organization.md)

**active**: true

**type**: Médical

**name**: Medical office CC CC
...
```json
{
  ...
  "_name" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "Medical office CC CC"
      }],
