...
> **participant****member**: [Organization Medical office CC CC](Organization-cds-organization-example.md)**period**: 2013-01-12 --> 2032-12-18 13:48:19+0100

**managingOrganization**: [Organization Medical office CC CC](Organization-cds-organization-example.md)
...
```json
{
  ...
  "_name" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "Care Circle of Mr. Jacques Thobois"
      }],
