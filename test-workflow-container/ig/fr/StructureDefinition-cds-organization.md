...
## Profil de ressource: CDS Organization Profile 
...
* Référence ce Profil: [CDS CareTeam Profile](StructureDefinition-cds-ihe-careteam.md) and [CDS Organization Profile](StructureDefinition-cds-organization.md)
* Exemples pour ce/t/te Profil: [Cabinet médical CC CC](Organization-cds-organization-example.md)
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.cds|current/StructureDefinition/cds-organization)
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-06-25T14:06:22+00:00",
